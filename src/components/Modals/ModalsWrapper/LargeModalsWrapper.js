      ...
      <Transition.Root show={modalOpen} as={Fragment}>
        ...
        >
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="bg-transparent pb-5 inline-block overflow-hidden transform transition-all sm:my-8 align-middle max-w-3xl sm:w-full">
...
export default LargeModalsWrapper;
